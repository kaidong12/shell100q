...
ip a a fd53:7cb8:383:4::10/64 dev eth_main
ip a a fd53:7cb8:383:3::fc10/64 dev br1

ip l a v-gw type veth peer name v-gw-br-conmod
ip l s v-gw up
ip l s v-gw-br-conmod up
ip link set v-gw-br-conmod master eth_main
ip a a fd53:7cb8:383:4::fc10/64 dev v-gw

ip netns add ns1
ip l s v1 netns ns1
ip netns exec ns1 ip l s v1 up
ip netns exec ns1 ip a a fd53:7cb8:383:3::73/64 dev v1
ip netns exec ns1 ip -6 route add fd53:7cb8:383:4::/64 via fd53:7cb8:383:3::fc10
