        ...
        stage('Execute') {
            steps {
                ...
                sh """
                    ...
                    virsh list --all
                    ping -c 5 10.0.99.15
                    grep -A 30 pm5: /home/tester/yaml/${params.YAML_PATH}/CEDGE_TLOC_EXT.yaml
                    date
                    echo "============================environment============================"
                    
                    echo "----------------------------------------------------------------------------------------------------"
                    # /home/tester/vtest/bin/runner tlocExt -ntg -ns -evm -m CEDGE_TLOC_EXT -v -t setup -t P0 -q;
                    /home/tester/vtest/bin/runner tlocExt -ntg -ns -evm -m CEDGE_TLOC_EXT -v -y /home/tester/yaml/${params.YAML_PATH}/CEDGE_TLOC_EXT.yaml -n tb -o -b next -t setup -t P0 -q;
                    echo "----------------------------------------------------------------------------------------------------"
                    date
