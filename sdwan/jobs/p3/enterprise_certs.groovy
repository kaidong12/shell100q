        ...
        stage('Execute') {
            steps {
                ...
                sh """
                    ...
                    virsh list --all
                    ping -c 5 10.0.99.15
                    grep -A 30 pm5: /home/tester/yaml/${params.YAML_PATH}/enterprise_certs.yaml
                    date
                    echo "============================environment============================"
                    
                    echo "----------------------------------------------------------------------------------------------------"
                    # /home/tester/vtest/bin/runner enterprise_certs -no_caserver -v -ntr -ntg -ns -ntg -ns -m enterprise_certs -q;
                    /home/tester/vtest/bin/runner enterprise_certs -no_caserver -y /home/tester/yaml/${params.YAML_PATH}/enterprise_certs.yaml -v -ntr -ntg -ns -ntg -ns -m enterprise_certs -n tb -o -b next -q -npc;
                    echo "----------------------------------------------------------------------------------------------------"
                    date
