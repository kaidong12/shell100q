        ...
        stage('Execute') {
            steps {
                ...
                sh """
                    ...
                    virsh list --all
                    ping -c 5 10.0.99.15
                    grep -A 30 pm5: /home/tester/yaml/${params.YAML_PATH}/NTP_CEDGE.yaml
                    date
                    echo "============================environment============================"
                    
                    echo "----------------------------------------------------------------------------------------------------"
                    # /home/tester/vtest/bin/runner ntp -t setup -ivm -ntr -ntg -ns -m NTP_CEDGE -t P0 -iub -rub -q;
                    /home/tester/vtest/bin/runner ntp -t setup -ivm -ntr -ntg -ns -m NTP_CEDGE -y /home/tester/yaml/${params.YAML_PATH}/NTP_CEDGE.yaml -n tb -o -b next -t P0 -iub -rub -q;
                    echo "----------------------------------------------------------------------------------------------------"
                    date
