        ...
        stage('Execute') {
            steps {
                ...
                sh """
                    ...
                    virsh list --all
                    ping -c 5 10.0.99.15
                    grep -A 30 pm5: /home/tester/yaml/${params.YAML_PATH}/CEDGE_LOGGING.yaml
                    date
                    echo "============================environment============================"
                    
                    echo "----------------------------------------------------------------------------------------------------"
                    # /home/tester/vtest/bin/runner cedge_syslog -v -ntr -ntg -ns -ivm -m CEDGE_LOGGING -t setup -t P0 -iub -rub -q;
                    /home/tester/vtest/bin/runner cedge_syslog -v -ntr -ntg -ns -ivm -m CEDGE_LOGGING -y /home/tester/yaml/${params.YAML_PATH}/CEDGE_LOGGING.yaml -n tb -o -b next -t setup -t P0 -iub -rub -q;
                    echo "----------------------------------------------------------------------------------------------------"
                    date
