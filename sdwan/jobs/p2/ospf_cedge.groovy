        ...
        stage('Execute') {
            steps {
                ...
                sh """
                    ...
                    virsh list --all
                    ping -c 5 10.0.99.15
                    grep -A 30 pm5: /home/tester/yaml/${params.YAML_PATH}/CEDGE_OSPF.yaml
                    date
                    echo "============================environment============================"
                    
                    echo "----------------------------------------------------------------------------------------------------"
                    # /home/tester/vtest/bin/runner ospf_cedge -v -ntr -ns -ntg -ncl -ivm -m CEDGE_OSPF -t setup -t P0 -q;
                    /home/tester/vtest/bin/runner ospf_cedge -y /home/tester/yaml/${params.YAML_PATH}/CEDGE_OSPF.yaml -v -n tb -ntr -ns -ntg -ncl -ivm -m CEDGE_OSPF -o -b next -t setup -t P0 -q;
                    echo "----------------------------------------------------------------------------------------------------"
                    date
