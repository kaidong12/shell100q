        ...
        stage('Execute') {
            steps {
                ...
                sh """
                    ...
                    virsh list --all
                    ping -c 5 10.0.99.15
                    grep -A 30 pm5: /home/tester/yaml/${params.YAML_PATH}/CEDGE_BFD.yaml
                    date
                    echo "============================environment============================"
                    
                    echo "----------------------------------------------------------------------------------------------------"
                    # /home/tester/vtest/bin/runner cEdgeBFD -v -ntr -ns -ivm -ntg -m cEdgeBFD -t setup -t P0 -q;
                    /home/tester/vtest/bin/runner cEdgeBFD -v -ntr -ns -ivm -ntg -m cEdgeBFD -y /home/tester/yaml/${params.YAML_PATH}/CEDGE_BFD.yaml -n tb -o -b next -t setup -t P0 -q;
                    echo "----------------------------------------------------------------------------------------------------"
                    date
