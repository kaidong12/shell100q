        ...
        stage('Execute') {
            steps {
                ...
                sh """
                    ...
                    virsh list --all
                    ping -c 5 10.0.99.15
                    grep -A 30 pm5: /home/tester/yaml/${params.YAML_PATH}/configuration_groups_20_9.yaml
                    date
                    echo "============================environment============================"
                    
                    echo "----------------------------------------------------------------------------------------------------"
                    # /home/tester/vtest/bin/runner configuration_groups_20_9 -ntr -ns -ntg -ncl -n tb -m config_group -t setup -t plat -et test_lan_vpn_interface_ethernet_parcel -q;
                    /home/tester/vtest/bin/runner configuration_groups_20_9 -ntr -ns -ntg -ncl -n tb -m config_group -y /home/tester/yaml/${params.YAML_PATH}/configuration_groups_20_9.yaml -b next -o -t setup -t plat -et test_lan_vpn_interface_ethernet_parcel -q;
                    echo "----------------------------------------------------------------------------------------------------"
                    date
