        ...
        stage('Execute') {
            steps {
                ...
                sh """
                    ...
                    virsh list --all
                    ping -c 5 10.0.99.15
                    grep -A 30 pm5: /home/tester/yaml/${params.YAML_PATH}/sdwan_init_dca_cedge_template_validation.yaml
                    date
                    echo "============================environment============================"
                    
                    echo "----------------------------------------------------------------------------------------------------"
                    # /home/tester/vtest/bin/runner config_group_dca_cedge_template_validation -ns -ntr -ntg -t cedge -m dca;
                    /home/tester/vtest/bin/runner config_group_dca_cedge_template_validation -ns -ntr -ntg -m dca -y /home/tester/yaml/${params.YAML_PATH}/sdwan_init_dca_cedge_template_validation.yaml -n tb -b next -o;
                    echo "----------------------------------------------------------------------------------------------------"
                    date
