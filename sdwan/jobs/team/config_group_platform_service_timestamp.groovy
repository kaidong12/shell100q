        ...
        stage('Execute') {
            steps {
                ...
                sh """
                    ...
                    virsh list --all
                    ping -c 5 10.0.99.15
                    grep -A 30 pm5: /home/tester/yaml/${params.YAML_PATH}/sdwan_init_platform_service_timestamp.yaml
                    date
                    echo "============================environment============================"
                    
                    echo "----------------------------------------------------------------------------------------------------"
                    # /home/tester/vtest/bin/runner config_group_platform_service_timestamp -ns -ntr -ntg -m platform_timestamp -et setup;
                    /home/tester/vtest/bin/runner config_group_platform_service_timestamp -ns -ntr -ntg -m platform_timestamp -y /home/tester/yaml/${params.YAML_PATH}/sdwan_init_platform_service_timestamp.yaml -n tb -b next -o;
                    echo "----------------------------------------------------------------------------------------------------"
                    date
