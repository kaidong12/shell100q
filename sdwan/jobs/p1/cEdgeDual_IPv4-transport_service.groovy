        ...
        stage('Execute') {
            steps {
                ...
                sh """
                    ...
                    virsh list --all
                    ping -c 5 10.0.99.15
                    grep -A 30 pm5: /home/tester/yaml/${params.YAML_PATH}/cEdgeDual_IPv4-transport_service.yaml
                    date
                    echo "============================environment============================"
                    
                    echo "----------------------------------------------------------------------------------------------------"
                    # /home/tester/vtest/bin/runner cEdgeDual -ns -ntg -ntr -m cEdgeDual_IPv4-transport_service -ivm -v -q;
                    /home/tester/vtest/bin/runner cEdgeDual -ns -ntg -ntr -m cEdgeDual_IPv4-transport_service -ivm -v -y /home/tester/yaml/${params.YAML_PATH}/cEdgeDual_IPv4-transport_service.yaml -n tb -o -b next -q;
                    echo "----------------------------------------------------------------------------------------------------"
                    date
