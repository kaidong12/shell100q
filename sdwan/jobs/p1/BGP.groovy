        ...
        stage('Execute') {
            steps {
                ...
                sh """
                    ...
                    virsh list --all
                    ping -c 5 10.0.99.15
                    grep -A 30 pm5: /home/tester/yaml/${params.YAML_PATH}/CEDGE_BGP.yaml
                    date
                    echo "============================environment============================"
                    
                    echo "----------------------------------------------------------------------------------------------------"
                    # /home/tester/vtest/bin/runner bgp -et multivrrp -v -ntr -ns -ivm -m CEDGE_BGP -t setup -t P0 -q;
                    /home/tester/vtest/bin/runner bgp -et multivrrp -v -ntr -ns -ivm -m CEDGE_BGP -y /home/tester/yaml/${params.YAML_PATH}/CEDGE_BGP.yaml -n tb -o -b next -t setup -t P0 -q;
                    echo "----------------------------------------------------------------------------------------------------"
                    date
