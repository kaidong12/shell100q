        ...
        stage('Execute') {
            steps {
                ...
                sh """
                    ...
                    virsh list --all
                    ping -c 5 10.0.99.15
                    grep -A 30 pm5: /home/tester/yaml/${params.YAML_PATH}/BGP_VRRP.yaml
                    date
                    echo "============================environment============================"
                    
                    echo "----------------------------------------------------------------------------------------------------"
                    # /home/tester/vtest/bin/runner bgp_vrrp_cedge -v -evm -ntr -ns -ntg -m BGP_VRRP -q;
                    /home/tester/vtest/bin/runner bgp_vrrp_cedge -y /home/tester/yaml/${params.YAML_PATH}/BGP_VRRP.yaml -n tb -o -b next -v -evm -ntr -ns -ntg -m BGP_VRRP -q;
                    echo "----------------------------------------------------------------------------------------------------"
                    date
