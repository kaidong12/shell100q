...
alias cdyc="cd /home/tester/yaml/current"
alias cdyl="cd /home/tester/yaml/logs/"
alias cdi="cd /home/tester/images"
alias cdic="cd /home/tester/images/current"

alias cdl="cd /home/tester/vtest/tests/logs/current_log"
alias cds="cd /home/tester/vtest/tests/scripts"

alias checkrun="ps -ef | grep vtest | grep -P 'testbed|run'"
alias clearrun='ps -ef | grep vtest | grep -P '\''testbed|run'\'' | awk '\''{print $2}'\'' | xargs -r kill -9'
